...
def add_features(train_path='https://s3.amazonaws.com/nyc-tlc/trip+data/green_tripdata_2021-01.parquet',
 val_path='https://s3.amazonaws.com/nyc-tlc/trip+data/green_tripdata_2021-01.parquet'):
